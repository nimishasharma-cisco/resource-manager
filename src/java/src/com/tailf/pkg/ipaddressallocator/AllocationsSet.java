...
public class AllocationsSet extends HashSet<Allocation> {
    ...
    public boolean addSyncMode(NavuNode opRoot, Allocation e) throws ConfException {
        ...
        if (res) {
            ...
            NavuNode allocation = poolOper.list(ipaddressAllocatorOper._allocation_)
                    .safeCreate(new ConfKey(keys));
            allocation.leaf(ipaddressAllocatorOper._owner_).set(e.getOccupant());
            allocation.leaf(ipaddressAllocatorOper._username_).set(e.getUsername());
            allocation.leaf(ipaddressAllocatorOper._request_id_).set(e.getRequestId());
        }
        return res;
    }
